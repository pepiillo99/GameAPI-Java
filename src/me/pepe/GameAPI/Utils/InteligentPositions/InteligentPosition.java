...
/*
  ...
  <position>
      <PorcentInteligentPosition> <!-- Ser� necesario meter o el menu o el windows -->
       <x>0</x>
       <y>0</y>
     </PorcentInteligentPosition>
    </position>
    <position>
     <ReferenceBordersInteligentPosition> <!-- Ser� necesario meter o el menu o el windows -->
       <x>0</x>
       <y>0</y>
    ...
    <position>
     <ReferenceObjectInteligentPosition> <!-- Ser� necesraio meter el objeto-->
		...
		if (screenOrMenu instanceof Screen || screenOrMenu instanceof Menu) {
			...
			if (DOMUtils.getChild(node, "PorcentInteligentPosition") != null) {
				...
				try {
					...
					System.err.println(DOMUtils.getXML(node) + " no devolvi� los valores esperados...");
				}
